      ...
      <div className="row p-3 d-flex justify-content-center text-center">
        <div className="p-3 col-12 col-md-10">
          <div className="row card d-flex flex-row" style={{ height: "450px" }}>
            <div className="col-12 pt-5 d-flex align-items-center col-md-6">
              <img
                src={data.image}
            ...
            <div className="col-12 col-md-6 d-flex justify-content-center text-center flex-column align-items-center">
